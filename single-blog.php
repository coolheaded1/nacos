            ...
            <div class="col-lg-8 m-auto text-center">
                <div class="page-title-content">
                    ...
                    <p>Alumni Needs enables you to harness the power of your alumni network. Whatever may be the
                        need</p>
                    <a href="single-blog.html#page-content-wrap" class="btn btn-brand smooth-scroll">Let's See</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <header class="article-head">
                            ...
                            <div class="single-blog-meta">
                                ...
                                <div class="posting-info">
                                    <a href="single-blog.html#">23 May 2017</a> • Posted by: <a href="single-blog.html#">Admin</a>
                                </div>
                            </div>
                        </header>
                            ...
                            <div class="row no-gutters ">
                                <div class="col-8">
                                    <div class="shareonsocial">
                                        ...
                                        <a href="single-blog.html#"><i class="fa fa-linkedin"></i></a>
                                        <a href="single-blog.html#"><i class="fa fa-vimeo"></i></a>
                                    </div>
                                </div>
                                <div class="col-4 text-right">
                                    <div class="post-like-comm">
                                        <a href="single-blog.html#"><i class="fa fa-thumbs-o-up"></i>20</a>
                                        <a href="single-blog.html#"><i class="fa fa-comment-o"></i>15</a>
                                    </div>
                                </div>
                            </div>
                        </footer>
...
<div class="sidebar-area-wrap">
       ...
       <h4 class="sidebar-title">Categories</h4>
        <div class="sidebar-body">
            <ul class="brand-unorderlist">
                <li><a href="single-blog.html#">Scholership</a></li>
                <li><a href="single-blog.html#">Alumni</a></li>
                <li><a href="single-blog.html#">Events</a></li>
                <li><a href="single-blog.html#">Member</a></li>
                <li><a href="single-blog.html#">Tour</a></li>
                <li><a href="single-blog.html#">Current Student</a></li>
    ...
    <div class="single-sidebar-wrap d-none d-lg-block">
       <h4 class="sidebar-title">Popular Tags</h4>
        <div class="sidebar-body">
            <div class="tags">
                <a href="single-blog.html#">Bootstrap</a>
                <a href="single-blog.html#">Design</a>
                <a href="single-blog.html#">web</a>
                <a class="active" href="single-blog.html#">custom</a>
                <a href="single-blog.html#">wordpres</a>
                <a href="single-blog.html#">Art</a>
                <a href="single-blog.html#">our team</a>
                <a href="single-blog.html#">Classic</a>
            </div>
        </div>
    </div>
    <!-- Single Sidebar End -->
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="single-blog.html#">Phone: +8745 44 5444</a> <a href="single-blog.html#">Fax: +88474 156 362</a> <br> <a href="single-blog.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="single-blog.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="single-blog.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="single-blog.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="single-blog.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="single-blog.html#">Pricing Plan</a></li>
                                <li><a href="single-blog.html#">Categories</a></li>
                                <li><a href="single-blog.html#">Populer Deal</a></li>
...
<!--== Scroll Top ==-->
<a href="single-blog.html#" class="scroll-top">
