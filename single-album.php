        ...
        <div class="row">
            <div class="col-lg-8 m-auto text-center">
                <div class="page-title-content">
                    ...
                    <a href="single-album.html#page-content-wrap" class="btn btn-brand smooth-scroll">Let's See</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Single Gallery End -->
                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="single-album.html#" class="btn btn-brand btn-loadmore">Load More Photo</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="single-album.html#">Phone: +8745 44 5444</a> <a href="single-album.html#">Fax: +88474 156 362</a> <br> <a href="single-album.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="single-album.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="single-album.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="single-album.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="single-album.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="single-album.html#">Pricing Plan</a></li>
                                <li><a href="single-album.html#">Categories</a></li>
                                <li><a href="single-album.html#">Populer Deal</a></li>
                                <li><a href="single-album.html#">FAQ</a></li>
                                <li><a href="single-album.html#">Support</a></li>
                                <li><a href="single-album.html#">Pricing Plan</a></li>
                                <li><a href="single-album.html#">Categories</a></li>
                                <li><a href="single-album.html#">Populer Deal</a></li>
                                <li><a href="single-album.html#">FAQ</a></li>
...
<!--== Scroll Top ==-->
<a href="single-album.html#" class="scroll-top">
