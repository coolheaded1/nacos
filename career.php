            ...
            <div class="row">
                <div class="col-lg-8 m-auto text-center">
                    <div class="page-title-content">
                        ...
                        <a href="career.html#page-content-wrap" class="btn btn-brand smooth-scroll">Let's See</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6 text-center">
                                <div class="single-job-opportunity">
                                    <div class="job-opportunity-text">
                                        ...
                                        <h3><a href="career.html#">Urgently Need Five Data Center Specialist</a></h3>
                                        <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="career.html#">[...]</a></p>
                                    </div>
                                    <a href="career.html#" class="btn btn-job">Apply now</a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 text-center">
                                <div class="single-job-opportunity">
                                    ...
                                    <a href="career.html#" class="btn btn-job btn-expired disabled">Expired</a>
                                </div>
                            </div>
                            <!--== Single Job opportunity End ==-->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="pagination-wrap text-center">
                                    <nav>
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link" href="career.html#"><i class="fa fa-angle-left"></i></a></li>
                                            <li class="page-item active"><a class="page-link" href="career.html#">1</a></li>
                                            <li class="page-item"><a class="page-link" href="career.html#">2</a></li>
                                            <li class="page-item"><a class="page-link" href="career.html#">3</a></li>
                                            <li class="page-item"><a class="page-link" href="career.html#">...</a></li>
                                            <li class="page-item"><a class="page-link" href="career.html#">50</a></li>
                                            <li class="page-item"><a class="page-link" href="career.html#"><i class="fa fa-angle-right"></i></a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="career.html#">Phone: +8745 44 5444</a> <a href="career.html#">Fax: +88474 156 362</a> <br> <a href="career.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="career.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="career.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="career.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="career.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="career.html#">Pricing Plan</a></li>
                                <li><a href="career.html#">Categories</a></li>
                                <li><a href="career.html#">Populer Deal</a></li>
...
<!--== Scroll Top ==-->
<a href="career.html#" class="scroll-top">
