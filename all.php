...
<section id="slider-area">
    ...
    <div class="social-networks-icon">
        <ul>
            <li><a href="index.html#"><i class="fa fa-facebook"></i> <span>7.2k Likes</span></a></li>
            <li><a href="index.html#"><i class="fa fa-twitter"></i> <span>3.2m Followers</span></a></li>
            <li><a href="index.html#"><i class="fa fa-pinterest"></i> <span>7.2k Likes</span></a></li>
            <li><a href="index.html#"><i class="fa fa-youtube"></i> <span>2.2k Subscribers</span></a></li>
        </ul>
    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">Urgently Need Five Data Center Specialist</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job">Apply now</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">Product Owner (m/f) for our Charter Business</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job">Apply now</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">Backend Developer (Java) (m/f) wanted for leading</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job btn-expired disabled">Expired</a>
                    </div>
                </div>
                <!--== Single Job opportunity End ==-->
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">API Architect and Lead - Python, SQLAlchemy, GraphQL</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job">Apply now</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">Remotely - Javascript Developer Node.js</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job btn-expired disabled">Expired</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index.html#">Five Years Experience Data Center Specialist Needed</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index.html#">[...]</a></p>
                        </div>
                        <a href="index.html#" class="btn btn-job">Apply now</a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    ...
                    <a href="index.html#" class="btn btn-brand">Apply Now</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <figure class="blog-thumb">
                        ...
                        <figcaption class="blog-meta clearfix">
                            ...
                            <div class="like-comm pull-right">
                                ...
                                <a href="index.html#"><i class="fa fa-heart-o"></i>12</a>
                            </div>
                        </figcaption>
                    </figure>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="index.html#">Phone: +8745 44 5444</a> <a href="index.html#">Fax: +88474 156 362</a> <br> <a href="index.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
