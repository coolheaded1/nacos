...
<section id="slider-area">
                    ...
                    <div class="col-lg-9">
                        <div class="slider-content">
                            ...
                            <div class="slider-btn">
                                <a href="index-offcanvas.html#about-area" class="btn btn-brand smooth-scroll">our mission</a>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="slider-content">
                            ...
                            <p>Alumni Needs enables you to harness the power of your alumni network. Whatever may be the need (academic, relocation, career, projects, mentorship, etc. you can ask the community and get responses in three.</p>
                            <div class="slider-btn">
                                <a href="index-offcanvas.html#" class="btn btn-brand">our mission</a>
                                <a href="index-offcanvas.html#" class="btn btn-brand-rev">our story</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="social-networks-icon">
        <ul>
            <li><a href="index-offcanvas.html#"><i class="fa fa-facebook"></i> <span>7.2k Likes</span></a></li>
            <li><a href="index-offcanvas.html#"><i class="fa fa-twitter"></i> <span>3.2m Followers</span></a></li>
            <li><a href="index-offcanvas.html#"><i class="fa fa-pinterest"></i> <span>7.2k Likes</span></a></li>
            <li><a href="index-offcanvas.html#"><i class="fa fa-youtube"></i> <span>2.2k Subscribers</span></a></li>
        </ul>
    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">Urgently Need Five Data Center Specialist</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job">Apply now</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">Product Owner (m/f) for our Charter Business</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job">Apply now</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">Backend Developer (Java) (m/f) wanted for leading</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job btn-expired disabled">Expired</a>
                    </div>
                </div>
                <!--== Single Job opportunity End ==-->
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">API Architect and Lead - Python, SQLAlchemy, GraphQL</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job">Apply now</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">Remotely - Javascript Developer Node.js</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job btn-expired disabled">Expired</a>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 text-center">
                    <div class="single-job-opportunity">
                        <div class="job-opportunity-text">
                            ...
                            <h3><a href="index-offcanvas.html#">Five Years Experience Data Center Specialist Needed</a></h3>
                            <p>Claritas est etiam procsus dymicus, qui sequitur mutationem Claritas est etiam procsus est etiam procsus dymicus.<a href="index-offcanvas.html#">[...]</a></p>
                        </div>
                        <a href="index-offcanvas.html#" class="btn btn-job">Apply now</a>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="scholership-promo-text">
                    ...
                    <a href="index-offcanvas.html#" class="btn btn-brand">Apply Now</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <figure class="blog-thumb">
                        ...
                        <figcaption class="blog-meta clearfix">
                            ...
                            <div class="like-comm pull-right">
                                <a href="index-offcanvas.html#"><i class="fa fa-comment-o"></i>77</a>
                                <a href="index-offcanvas.html#"><i class="fa fa-heart-o"></i>12</a>
                            </div>
                        </figcaption>
                    </figure>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="index-offcanvas.html#">Phone: +8745 44 5444</a> <a href="index-offcanvas.html#">Fax: +88474 156 362</a> <br> <a href="index-offcanvas.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="index-offcanvas.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="index-offcanvas.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="index-offcanvas.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="index-offcanvas.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="index-offcanvas.html#">Pricing Plan</a></li>
                                <li><a href="index-offcanvas.html#">Categories</a></li>
                                <li><a href="index-offcanvas.html#">Populer Deal</a></li>
                                <li><a href="index-offcanvas.html#">FAQ</a></li>
                                <li><a href="index-offcanvas.html#">Support</a></li>
                                <li><a href="index-offcanvas.html#">Pricing Plan</a></li>
                                <li><a href="index-offcanvas.html#">Categories</a></li>
                                <li><a href="index-offcanvas.html#">Populer Deal</a></li>
                                <li><a href="index-offcanvas.html#">FAQ</a></li>
...
<!--== Scroll Top ==-->
<a href="index-offcanvas.html#" class="scroll-top">
