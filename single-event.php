            ...
            <div class="col-lg-8 m-auto text-center">
                <div class="page-title-content">
                    ...
                    <p>Alumni Needs enables you to harness the power of your alumni network. Whatever may be the
                        need</p>
                    <a href="single-event.html#page-content-wrap" class="btn btn-brand smooth-scroll">Let's See</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="event-thumbnail-carousel owl-carousel">
                                <div class="event-thumb-item event-thumb-img-1">
                                    <div class="event-meta">
                                        ...
                                        <a class="event-address" href="single-event.html#"><i class="fa fa-map-marker"></i> Sayidan Street, Gondomanan, 8993, San Francisco, CA</a>
                                        <a href="single-event.html#" class="btn btn-brand btn-join">Join</a>
                                    </div>
                                </div>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="single-event.html#">Phone: +8745 44 5444</a> <a href="single-event.html#">Fax: +88474 156 362</a> <br> <a href="single-event.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="single-event.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="single-event.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="single-event.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="single-event.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="single-event.html#">Pricing Plan</a></li>
                                <li><a href="single-event.html#">Categories</a></li>
                                <li><a href="single-event.html#">Populer Deal</a></li>
                                <li><a href="single-event.html#">FAQ</a></li>
                                <li><a href="single-event.html#">Support</a></li>
                                <li><a href="single-event.html#">Pricing Plan</a></li>
                                <li><a href="single-event.html#">Categories</a></li>
                                <li><a href="single-event.html#">Populer Deal</a></li>
                                <li><a href="single-event.html#">FAQ</a></li>
...
<!--== Scroll Top ==-->
<a href="single-event.html#" class="scroll-top">
    <i class="fa fa-angle-up"></i>
</a>
<!--== Scroll Top ==-->
