                                        ...
                                        <figure class="blog-thumb">
                                            ...
                                            <figcaption class="blog-meta clearfix">
                                                ...
                                                <div class="like-comm pull-right">
                                                    <a href="blog.html#"><i class="fa fa-comment-o"></i>77</a>
                                                    <a href="blog.html#"><i class="fa fa-heart-o"></i>12</a>
                                                </div>
                                            </figcaption>
                                        </figure>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="pagination-wrap text-center">
                                        <nav>
                                            <ul class="pagination">
                                                <li class="page-item"><a class="page-link" href="blog.html#"><i class="fa fa-angle-left"></i></a></li>
                                                ...
                                                <li class="page-item"><a class="page-link" href="blog.html#">50</a></li>
                                                <li class="page-item"><a class="page-link" href="blog.html#"><i class="fa fa-angle-right"></i></a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
...
<div class="sidebar-area-wrap">
       ...
       <h4 class="sidebar-title">Categories</h4>
        <div class="sidebar-body">
            <ul class="brand-unorderlist">
                <li><a href="blog.html#">Scholership</a></li>
                ...
                <li><a href="blog.html#">Current Student</a></li>
    ...
    <div class="single-sidebar-wrap d-none d-lg-block">
       <h4 class="sidebar-title">Popular Tags</h4>
        <div class="sidebar-body">
            <div class="tags">
                <a href="blog.html#">Bootstrap</a>
                <a href="blog.html#">Design</a>
                <a href="blog.html#">web</a>
                <a class="active" href="blog.html#">custom</a>
                <a href="blog.html#">wordpres</a>
                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="blog.html#">Phone: +8745 44 5444</a> <a href="blog.html#">Fax: +88474 156 362</a> <br> <a href="blog.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="blog.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="blog.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="blog.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="blog.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="blog.html#">Pricing Plan</a></li>
                                <li><a href="blog.html#">Categories</a></li>
                                <li><a href="blog.html#">Populer Deal</a></li>
...
<!--== Scroll Top ==-->
<a href="blog.html#" class="scroll-top">
