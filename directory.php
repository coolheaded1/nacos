                    ...
                    <div class="single-widget-wrap">
                        <div class="widgei-body">
                            <div class="footer-about">
                                ...
                                <a href="directory.html#">Phone: +8745 44 5444</a> <a href="directory.html#">Fax: +88474 156 362</a> <br> <a href="directory.html#">Email: demoemail@demo.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            ...
                            <div class="footer-social-icons">
                                <a href="directory.html#" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="directory.html#" target="_blank"><i class="fa fa-twitter"></i></a>
                                <a href="directory.html#" target="_blank"><i class="fa fa-linkedin"></i></a>
                                <a href="directory.html#" target="_blank"><i class="fa fa-vimeo"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-widget-wrap">
                        ...
                        <div class="widgei-body">
                            <ul class="double-list footer-list clearfix">
                                <li><a href="directory.html#">Pricing Plan</a></li>
                                <li><a href="directory.html#">Categories</a></li>
                                <li><a href="directory.html#">Populer Deal</a></li>
                                <li><a href="directory.html#">FAQ</a></li>
                                <li><a href="directory.html#">Support</a></li>
                                <li><a href="directory.html#">Pricing Plan</a></li>
                                <li><a href="directory.html#">Categories</a></li>
                                <li><a href="directory.html#">Populer Deal</a></li>
                                <li><a href="directory.html#">FAQ</a></li>
...
<!--== Scroll Top ==-->
<a href="directory.html#" class="scroll-top">
